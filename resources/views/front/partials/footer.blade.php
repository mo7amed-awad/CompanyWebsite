        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="d-flex pt-2">
                    ...
                    <a class="btn btn-outline-light btn-social" href="{{$settings->facebook}}"><i class="fab fa-facebook"></i></a>
                    @endif
                    @if($settings->youtube)
                    <a class="btn btn-outline-light btn-social" href="{{$settings->youtube}}"><i class="fab fa-youtube"></i></a>
                    @endif
                    @if($settings->instagram)
                    <a class="btn btn-outline-light btn-social" href="{{$settings->instagram}}"><i class="fab fa-instagram"></i></a>
                    @endif
                    @if($settings->linkedin)
                    <a class="btn btn-outline-light btn-social" href="{{$settings->linkedin}}"><i class="fab fa-linkedin"></i></a>
                    @endif
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
