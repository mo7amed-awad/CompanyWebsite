                                ...
                                @if (count($testmonials) > 0)
                                    @foreach ($testmonials as $testmonial)
                                        <tr>
                                            ...
                                            <td>
                                                <x-action-button href="{{route('admin.testmonials.edit',$testmonial)}}" type="edit"></x-action-button>
                                                <x-action-button href="{{route('admin.testmonials.show',$testmonial)}}" type="show"></x-action-button>
                                                <x-delete-button href="{{route('admin.testmonials.destroy',$testmonial)}}" id="{{$testmonial->id}}"></x-delete-button>
                                            </td>
                                    @endforeach
                                @else
                                   <x-empty-alert/>
